    ...
    <section
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="mb-14 max-w-3xl">
          <Badge className="mb-5 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.22em] text-primary">
            Contact Code Red
          </Badge>

          <h2 className="max-w-3xl text-4xl font-black uppercase tracking-tighter text-foreground md:text-6xl">
            LET&apos;S BUILD THE RIGHT
            <span className="block italic text-primary">NEXT STEP.</span>
          </h2>

          <p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground md:text-lg">
            Whether you are a school seeking support or a strategic partner
            exploring collaboration, use the appropriate path below to connect
            with the right team.
          </p>
        </div>
            ...
            <div className="mt-8 space-y-4">
              {panelContent.highlights.map((item) => (
                <div
                  ...
                  <h5 className="text-sm font-black uppercase tracking-[0.14em] text-foreground">
                    {item.title}
                  </h5>
                  <p className="mt-2 text-sm leading-6 text-muted-foreground">
                    {item.body}
